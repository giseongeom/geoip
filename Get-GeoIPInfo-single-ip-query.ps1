...
:RemoteAddreLoop ForEach ($my in $netstat_remote_list) {
  ...
  if (-not(Test-RFC1918IPv4Address -IPAddress $RemoteAddress)) {
      ...
      $lookupResult = Find-GeoIp2 -Library $maxMindDbDll -Database $ipDbIsp -IpAddress $RemoteAddress | ConvertTo-Json -Depth 5 | ConvertFrom-Json
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB5B3jHmlulR4Js
# Dl1azXQye2sBPSznKwx1IliRQoNpVaCCFgswggPuMIIDV6ADAgECAhB+k+v7fMZO
...
# BAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBYzD+KU2dRQ
# xbj9/1PTSxPOnZJKywHQE+d5O+fgZyXmMA0GCSqGSIb3DQEBAQUABIIBAEiOkYp8
# vODCdf/ZjPBUOgJ9+nRjr/8yLtMTqu5/9QnPg/u3u/d88W3j6APeWve/caOxhTt7
# HgSGI/kRb92sBSVMqMhIaWmiDOmXUPmiaJP1R/7ggB8xpOVCZzS5DZlJLYTEY5n4
# TXlpWSUuUtdN61g8KE9Hu9CLyx3E/m8Ze55lPAcxRt5KW8C97oLmkYBsQ70M5oWn
# b09pfkXkkSsOp8ZlS+oY+j1cFzrsLEaAgm9oOfEbOP1UTS125R5/mmHxhEubr8Cj
# fOSTOyyEG1u+O3d1D2yZOKjZ/heno2HKBpqtYMR0q8VYHGa8s/6yDs4EQ48KiDqc
# Tlsw5q0dfw4uEl2hggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQsw
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMDE4MDUyMTA4WjAjBgkqhkiG9w0BCQQx
# FgQUEt6KUE9fOmGsMIO0tlIzJcvhGuMwDQYJKoZIhvcNAQEBBQAEggEAWlgcBPFV
# CRhLqRZ+NSC31W1Vt65mL0v+vIIdm8d2TEipHTyB42CswzFe36hwEzrGiQvORKnh
# eLjFGGdD8HTY17UcE1IEoS+PdCh33sSsuKU0OWI0vfOi2/RXXH8VtE/28kbtMFux
# hXvNv7Fu2nTQ3KqaDOuLWhRkVz+iT7qunQeEIsbPBdl+pF9jVBNzQ9owOnf6kZSP
# Kl/XysJ1g0uZUqoZvOuNfXvcyMjnmVhFNfEkhhxuzWSNF25I1QWeZx2lPkMOx5Iu
# CzW+YkaEC0Uf0ITEO5cDte1gO5DlO+O57dMXaWK8of8mYWpZxXo038y19/d5GfHQ
# 6zUG25KPAGN8lA==
